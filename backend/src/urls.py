...
urlpatterns = [
    path(
        "api/auth/registerUser/", csrf_exempt(views.registerUser), name="registerUser"
    ),
    path(
        "api/auth/registerCompany/",
        csrf_exempt(views.registerCompany),
    ...
    path("SuccessfulLogin#/", views.redictHome, name="redirectHome"),
]
